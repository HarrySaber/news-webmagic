...
public class HikariDataSourceProvider implements Provider<DataSource> {
	...
	public void setConnectionTestStatement(@Named("hikari.connectionTestStatement") String connectionTestStatement) {
		dataSource.setConnectionTestQuery(connectionTestStatement);
	}

	@com.google.inject.Inject(optional = true)
	public void setMaxConnectionsPerPartition(@Named("hikari.maxPoolSize") int maxPoolSize) {
